...
import org.example.pminsu.functional.Experiments;
...
public class MonteCarloTest {
    public static void piDemo() {
        ...
        /*
         * 몬테카를로 iterator를 정의합니다. 오로지계산 방법 그 자체만을 있는 그대로 표현한 코드를 쓸 수 있습니다. 계산 시간(횟수)와 계산 공간 문제 곧 계산
        ...
        System.out.println(get(pi, 100_000));
    }
    ...
    private static void potionTestWithInfiniteIterators() {
         ...
         */
        final double herbRatio = 0.2; // 좋은 약초를 발견할 확률
        Iterator<Integer> herbAvailablities = Mathx.binaryDistribution(herbRatio); // 0.2보다 작으면 1, 크면 0
        /*
         ...
         * 왜 짰는지 설명하기
         * 공학적으로 설계
         * 소수의 부품을 여러 곳의 프로그램에 사용이 가능하게 만들기
         * 자바독으로 설명해놓기
         * */
        Iterator<Quality> herbQualities = zip((availablitie, quality) -> {
                    if (availablitie == 1) {
                        return Quality.BEST;
                    }
         ...
         */
        toList(limit(medicineEffects, 7000));
    }
